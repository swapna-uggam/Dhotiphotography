...
//           className="text-2xl lg:mt-4 md:text-4xl lg:text-5xl -mt-9 font-bold text-[#800000] mb-4 leading-tight"
//         >
...
//           className="text-xs text-[#5D4037] font-[Palatino] mb-8 max-w-lg mx-auto lg:text-lg md-text-xl lg:mx-0 space-y-3"
//         >
//           <p>
...
//         {/* Buttons */}
//         <div className="space-x-3 md:ml-50 lg:space-y-3 mt-6">
...
//       {/* Right Side – Rotating Firestore Image */}
...
export default function HeroSection() {
  ...
  return (
    <section id="HeroSection" className="relative bg-[#F9F5EC] flex flex-col lg:flex-row items-start px-6 pb-20 overflow-hidden">
      {/* Left Text Block */}
      <div className="w-full lg:w-1/2 text-center lg:text-left mt-12 lg:mt-0 lg:pr-10">
        <motion.h1
          initial={{ opacity: 0, x: -30 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.6 }}
          className="text-2xl md:text-4xl lg:text-5xl font-bold text-[#800000] mb-4 leading-tight"
        >
          Capture Your Culture{" "}
          <span className="text-[#D4AF37] lg:ml-45 lg:text-5xl italic inline-block">Dhoti</span>
        </motion.h1>
            ...
            <div className="flex flex-col gap-3 mt-1">
              <Link href="#ContactSection">
                <motion.button
                  whileHover={{ scale: 1.03 }}
                  whileTap={{ scale: 0.98 }}
                  className="px-6 py-3 bg-[#D4AF37] text-white text-sm lg:text-base font-semibold rounded-full shadow-md hover:bg-[#c19b2c]"
                >
                  Book Your Session
                </motion.button>
              </Link>
              <Link href="#GallerySection">
                <motion.button
                  whileHover={{ scale: 1.03 }}
                  whileTap={{ scale: 0.98 }}
                  className="px-6 py-3 bg-white border border-[#D4AF37] text-[#5D4037] text-sm lg:text-base font-semibold rounded-full shadow-md hover:bg-[#f5f0e4]"
                >
                  See Our Gallery
                </motion.button>
              </Link>
      ...
      {/* Right Image Side */}
      <div className="w-full lg:w-1/2 flex justify-center items-center mt-10 lg:mt-4">
        <div className="relative w-[450px] h-[350px] md:w-[420px] md:h-[480px] lg:w-[250px] lg:h-[320px] xl:w-[580px] xl:h-[680px] 2xl:w-[460px] 2xl:h-[580px]">
          <AnimatePresence mode="wait">
            {images.map((img, idx) =>
              idx === currentImageIndex ? (
                <motion.div
