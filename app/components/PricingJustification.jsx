    ...
    <section className="relative py-24 px-6 bg-gradient-to-b from-[#FFF8E1] via-[#FAF3DC] to-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          >
            <div className="w-24 h-1 bg-[#D4AF37] mx-auto mb-4 rounded-full" />
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#800000] tracking-tight">
          ...
          <motion.p
            className="text-[#5D4037] mt-6 text-lg md:text-xl lg:text-2xl max-w-3xl mx-auto leading-relaxed"
            initial={{ opacity: 0 }}
            ...
            >
              ...
              <div className="h-full bg-white bg-opacity-90 backdrop-blur-sm p-8 rounded-3xl border border-[#D4AF37]/30 shadow-[0_10px_30px_rgba(128,0,0,0.08)] transition-all duration-300 hover:shadow-[0_15px_40px_rgba(128,0,0,0.15)] hover:border-[#D4AF37]/50 hover:translate-y-[-5px]">
                ...
                <div className="pt-6 pl-4">
                  <h3 className="text-2xl font-bold text-[#800000] mb-4 font-serif tracking-wide">
                    {item.title}
                  </h3>
        ...
        >
          <div className="inline-block px-8 py-3 bg-gradient-to-r from-[#D4AF37]/20 to-[#800000]/20 rounded-full backdrop-blur-sm border border-[#D4AF37]/30">
